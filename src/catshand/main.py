import argparse
from catshand.tools import prjgen, prjpre, prjpost, audacitypipe, highlight, audmerger, linkparser, convert_to_wav, prjsummary, mt_removesilent
...
def main():
    ...
    convert_to_wav.add_subparser(subparsers)
